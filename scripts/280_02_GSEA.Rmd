...
expr_tumor_top <- expr_tumor[top_genes_tumor3, ]
```
...
panda_results_normal <- pandaPy(expr_file = "../output/gtex_breast_expr_normal_filtered_logcpm.txt" , motif_file = "../data/motif_997TFs_ensembl.txt", ppi_file = "../data/ppi_997TFs.txt", modeProcess="legacy", remove_missing = TRUE)
